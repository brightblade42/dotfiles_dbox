...
(setq org-directory "/home/eyemetric/org/")
(setq projectile-project-search-path "/home/eyemetric/projects/work")
(desktop-save-mode t)
...
;;(load-env-file (expand-file-name "../.env" (file-name-directory load-file-name)))
